# .NET Mentoring Program Intermediate+ Practice [Q2/Q3, 2026 Global]

1. [Module 1: Help Module](./01_help_module/)
2. [Module 2: Ticketing Domain – Introduction](./02_ticketing_domain_introduction/)
3. [Module 3: Persistence Level (SQL, NoSQL) + DAL](./03_persistence_level/)
